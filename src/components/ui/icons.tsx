/**
 * Lightweight inline SVG icons (stroke = currentColor) so icons inherit theme
 * tokens automatically. Avoids pulling in an icon library.
 */
...
export const TwitterIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M18 2h3l-7 8 8 12h-6l-5-7-6 7H1l8-9L1 2h6l4 6 7-6Z" />
  </svg>
);
